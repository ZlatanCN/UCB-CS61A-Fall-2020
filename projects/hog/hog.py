...
def free_bacon(score):
    ...
    # BEGIN PROBLEM 2
    "*** YOUR CODE HERE ***"
    pi = FIRST_101_DIGITS_OF_PI // pow(10, (101 - (score + 1)))
    # END PROBLEM 2
...
def pig_pass(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 4b
    "*** YOUR CODE HERE ***"
    differenec = opponent_score - player_score
    if differenec <= 2 and differenec > 0:
        return True
    else:
        return False
    # END PROBLEM 4b
...
def announce_highest(who, last_score=0, running_high=0):
    ...
    "*** YOUR CODE HERE ***"
    def say(score0, score1):
        last_score_here = last_score
        running_high_here = running_high
        if who == 0:
            if score0 - last_score_here > running_high_here:
                running_high_here = score0 - last_score
                print(running_high_here, 'point(s)! The most yet for Player', who)
            last_score_here = score0
        else:
            if score1 - last_score_here > running_high_here:
                running_high_here = score1 - last_score_here
                print(running_high_here, 'point(s)! The most yet for Player', who)
            last_score_here = score1
        return announce_highest(who, last_score_here, running_high_here)
    return say
    # END PROBLEM 7
...
def max_scoring_num_rolls(dice=six_sided, trials_count=1000):
    ...
    while num <= 10:
        ...
        average_score = score(num, dice)
        if average_score > max_average_score:
            max_average_score = average_score
            max_average_score_num = num
        num += 1
    return max_average_score_num
    # END PROBLEM 9
